...
export default function StoreAddProduct() {
  ...
  // Trigger AI analysis only for the first image if AI hasn't been used yet
        ...
        await toast.promise(
          ...
          ),
          {
            ...
            success: (res) => {
              ...
              return "AI couldn't analyze the images";
            },
            error: (err) => err?.response?.data?.error || "Failed to analyze image",
          }
        );
      } catch (error) {
  ...
  const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            console.error(error); // Helpful to see the real error
            toast.error("Error adding product");
        } finally {
            // This finally block now correctly closes the logic
            setLoading(false);
        } // <--- THIS WAS MISSING
    } // <--- THIS CLOSES THE onSubmitHandler FUNCTION
    return (
